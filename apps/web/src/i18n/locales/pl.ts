...
export const pl: Dict = {
  // Auth login wall
  'auth.loginTitle': 'Zaloguj się do Open Design',
  'auth.loginSubtitle': 'Zaloguj się, aby kontynuować.',
  'auth.continueWithGoogle': 'Kontynuuj z Google',
  'auth.emailCode': 'Wyślij mi kod e-mailem',
  ...
  'auth.email': 'E-mail',
  'auth.password': 'Hasło',
  'auth.modeLabel': 'Tryb uwierzytelniania',
  'auth.failed': 'Uwierzytelnianie nie powiodło się',
  'auth.signOutFailed': 'Wylogowanie nie powiodło się',
